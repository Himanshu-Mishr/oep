...
<div id='input_info' color='black'>Enter Exam ID<input type="text" name="username" ><input type="submit" name="submit" value="GO"></div>
</form>
<?php
if (isset($_GET['submit'])) {
    $str="location:subject_delete.php?exam_id=".$_GET['username']."";
header($str);
}
?>
</center>
