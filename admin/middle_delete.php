...
<div id='input_info' color='black'>Enter Student Username <input type="text" name="username" ><input type="submit" name="submit" value="GO"></div>
</form>
<?php
if (isset($_GET['submit'])) {
    $str="location:admin_student_delete.php?id=".$_GET['username']."";
header($str);
}
?>
</center>
